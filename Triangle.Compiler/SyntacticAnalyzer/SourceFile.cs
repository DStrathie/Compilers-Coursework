...
namespace Triangle.Compiler.SyntacticAnalyzer
{
    ...
    public class SourceFile : IEnumerator<char>
    {
        ...
        /// </summary>
        public char Current { get { return buffer == null ? default(char) : buffer[index]; } }
        ...
        /// </summary>
        public Location Location { get { return new Location(lineNumber, index + 1); } }
        ...
        public void Reset()
        {
            ...
            if (!source.BaseStream.CanSeek) { throw new NotSupportedException(); }
